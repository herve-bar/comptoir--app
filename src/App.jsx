...
const PRODUITS_INIT = [
  { id: "p1", nom: "CafÃ© moulu 250g", prix: 4.5, stock: 32, seuil: 10, categorie: "Ã‰picerie" },
  { id: "p2", nom: "Savon artisanal", prix: 3.2, stock: 6, seuil: 8, categorie: "HygiÃ¨ne" },
  { id: "p3", nom: "Carnet lignÃ© A5", prix: 2.8, stock: 18, seuil: 5, categorie: "Papeterie" },
  { id: "p4", nom: "Bougie parfumÃ©e", prix: 7.9, stock: 3, seuil: 5, categorie: "DÃ©co" },
  { id: "p5", nom: "ThÃ© vert 100g", prix: 5.1, stock: 24, seuil: 10, categorie: "Ã‰picerie" },
];
...
function Sidebar({ page, setPage, panierCount, produits }) {
  ...
  return (
    <>
      ...
      <aside style={{ ...styles.sidebar, ...(ouvert ? styles.sidebarOpenMobile : {}) }}>
        <div style={styles.brandDesktopOnly}>
          <div style={styles.brand}>
            <div style={styles.brandStamp}>CO</div>
            <div>
              <div style={styles.brandName}>Comptoir</div>
      ...
      {ouvert && <div style={styles.overlayMobile} onClick={() => setOuvert(false)} />}
    </>
  );
}
      ...
      <form style={styles.modal} onClick={(e) => e.stopPropagation()} onSubmit={submit}>
        ...
        <div style={{ display: "flex", gap: 12 }}>
          <div style={{ flex: 1 }}>
            ...
            <input style={styles.input} type="number" step="0.01" min="0" value={prix} onChange={(e) => setPrix(e.target.value)} required />
          </div>
          <div style={{ flex: 1 }}>
...
const styles = {
  ...
  main: { flex: 1, padding: "32px 40px", overflowY: "auto", minWidth: 0, paddingBottom: 100 },
